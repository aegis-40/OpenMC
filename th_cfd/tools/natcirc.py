...
# -*- coding: utf-8 -*-
"""
SMR40 - Natural-circulation loop solver  (keystone: fixes the core flow G)
==========================================================================

The SMR40 primary loop has NO pumps: flow is driven only by the buoyancy head
...
def main(argv=None):
    cfg = Config()
    ap = argparse.ArgumentParser(description="SMR40 natural-circulation loop solver")
    ...
    r = solve(cfg)
    print("=" * 72)
    print(" SMR40 natural-circulation loop  (1-D buoyancy balance, mdot~P^1/3)")
    print("=" * 72)
