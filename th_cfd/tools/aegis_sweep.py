...
N_PIN = 9768             # 264 fuel pins * 37 FA  (FER design, was 21 FA/5544)
L     = 2.0              # active length
# peaking — FER design targets (notebook aegis40_neutronics_FER): F_q 2.0 / F_dH 1.55
F_Q, F_DH, F_Z = 2.00, 1.55, 1.29
LE_RATIO = 1.304         # Le 2.607 / L 2.0 -> F_z 1.29 (= F_q/F_dH = 2.0/1.55)
# solids
H_GAP, K_FUEL, K_CLAD = 5250.0, 3.5, 16.0              # He gap 91.5 um (eff.) / UO2 / Zr-4
