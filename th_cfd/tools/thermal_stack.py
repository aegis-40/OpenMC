...
# -*- coding: utf-8 -*-
"""
SMR40 - Correlation thermal stack  (Variant 1 post-processor)
=============================================================
...
def run(cool, st, csv=None, table=False, boiling=False):
    ...
    print("=" * 74)
    print(" SMR40 correlation thermal stack  (Variant 1: CFD flow + correlation h)")
    print("=" * 74)
...
def main(argv=None):
    ...
    ap = argparse.ArgumentParser(
        description="SMR40 correlation thermal stack (PCT, fuel centreline)",
