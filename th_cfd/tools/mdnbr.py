...
# -*- coding: utf-8 -*-
"""
SMR40 - MDNBR (Minimum Departure-from-Nucleate-Boiling Ratio) post-processor
============================================================================

Computes the hot-channel DNBR axial profile and its minimum (MDNBR) for the
SMR40 fuel pin, using the W-3 (Westinghouse-3 / Tong) critical-heat-flux
...
def run(cfg, csv=None, use_tong=True, table=False):
    ...
    # ----- report -----
    print("=" * 72)
    print(" SMR40 hot-channel DNBR  (W-3 CHF correlation"
...
def main(argv=None):
    ...
    ap = argparse.ArgumentParser(
        description="SMR40 MDNBR (W-3 CHF) post-processor",
