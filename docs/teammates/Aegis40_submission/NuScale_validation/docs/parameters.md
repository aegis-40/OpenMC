...
- Peaking: total **F_q = 1.923** (published NuScale BOC PPF, neutronic study;
  F_ΔH ≈ F_q/F_z(1.36) ≈ 1.42 — consistent with the published hot-leg/clad/Tsat data)
- Hot-pin peak linear power  q'_hot,peak = q'_avg · F_q ≈ **15.75 kW/m**  (160 MWt)
- Avg volumetric source in pellet  q''' = q'/(π·r_f²):
  - average pin:  8.19e3 / (π·0.004095²) = **1.55e8 W/m³**
  - hot pin peak: 15.75e3 / (π·0.004095²) = **2.99e8 W/m³**  (-> fvOptions qpeak)
