...
def main():
    ...
    para(doc, "All three meshes are run natively at the NuScale-calibrated power (F_q 1.923). "
              "In addition, running the medium mesh at two source levels confirmed that the "
              "single-phase constant-property conjugate problem is exactly linear in the heat "
              "source (temperature rises scale by the source ratio to ±0.01 K / ±0 Pa) — the "
              "basis for transferring the V&V conclusions across power levels.")
