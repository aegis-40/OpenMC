...
--------------------------------------------------------------------------------
 ...
 thermal_stack.py          python3 thermal_stack.py    PCT & fuel centreline
   Dittus-Boelter film + 1-D radial conduction + Jens-Lottes clamp.
   Envelope: PCT 353 C, fuel centreline 828 C.
