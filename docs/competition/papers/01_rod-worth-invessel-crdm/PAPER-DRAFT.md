...
is 844 pcm, **20 % above**, or 4.9σ. Those margins are far larger than the differences reported between
Monte-Carlo β_eff estimators in published method intercomparisons [23,24]. As a sensitivity, even a
