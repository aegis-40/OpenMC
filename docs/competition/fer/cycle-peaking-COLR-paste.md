...
MOC envelope (F_ΔH = 1.75, F_q = 2.47, MOC axial shape) confirms **MDNBR = 1.37 with the
conservative extrapolated W-3 correlation and 2.20 with the Bowring correlation (within its
...
| MOC COLR envelope (F_ΔH 1.75 / F_z 1.41) | 2.468 | **1.37** | **2.20** | 353 °C | 828 °C |
