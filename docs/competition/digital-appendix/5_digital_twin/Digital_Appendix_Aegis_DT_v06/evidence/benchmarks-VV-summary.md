...
## 7. Prepared, not run (optional upgrades)

Takahama-3 PIE pincell vs **SFCOMPO 2.0 (OECD/NEA assay database)** — script ready
(`benchmark_takahama_pincell.py`); would add a measured-isotopics depletion leg.

---

## 8. Digital-Appendix compliance check — "one sample input per code + explanations"
