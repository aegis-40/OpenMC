...
- SOE energy demand: Milewski, Kupecki et al., Int. J. Hydrogen Energy 46 (2021)
  35765-35776 -> 39 kWh/kg (O2- SOE design basis) vs 50 kWh/kg (PEM); steam fed from deaerator.
"""
...
SOE_KWH_PER_KG = 39.0          # SOE electrical demand, report Section 8.12 design basis (Milewski 2021 ~37.5)
...
# SOE hydrogen: off-peak night valley year-round (~6 h/night x ~347 nights ~= 2080 h),
# ~5% of net electricity to electrolysis -> ~427 t/yr (report Section 8.12 economics basis)
SOE_H_NIGHT     = 6
SOE_NIGHTS      = 347
