...
| 12 | SBLOCA / containment | Plant-specific suppression/IRWST mass-energy screening (blowdown + decay-heat + gravity-head balance); suppression phenomenology by reference: SMART100 CPRSS/SISTA, CAREM-25 **[LIT]**, NEA/CSNI suppression SOAR **[NEA]**, NUREG-0800 SRP 6.5.5 **[NRC]** | quasi-static P 0.139 MPa ≤ 0.414 MPa design (×3 margin); ≥ 16 h to design P with zero heat-removal credit | `02_Python_safety_toolchain/f6_suppression.py`; `docs/Aegis40_F3_F6_bounding.md` (repo) |
